...
import { AppWatcher, isFileBelongs, states, watchMulti } from "./watcher";
...
export function getBfspBuildService(watcher: AppWatcher): BuildService {
  return {
    watcher,
    walkFiles,
...
export function getBfswBuildService(watcher: AppWatcher): BuildService {
  return {
    watcher,
    walkFiles(
      dirpath: string,
