...
export * from "../main/configs/gitIgnore.mjs";
export * from "../main/configs/npmIgnore.mjs";
export * from "../main/configs/packageJson.mjs";
export * from "../main/configs/tsConfig.mjs";
export * from "../main/configs/viteConfig.mjs";
export * from "../main/bfspConfig.mjs";
export * from "../main/deps.mjs";
